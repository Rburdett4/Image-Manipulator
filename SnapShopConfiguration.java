...
public class SnapShopConfiguration
{
    ...
    {   theShop.setDefaultFilename("steve.jpg");
        ...
        theShop.addFilter(new SepiaFilter(), "Sepia Image");
        theShop.addFilter(new ZoomFilter(), "Zoom Image");
        theShop.addFilter(new WrapFilter(), "Wrap Image");
